(function () {
  ...
  var paletteActions = articleActions.concat([
    ...
    { icon: '🛠️', label: 'Jump to: Backend & Tech Stack', hint: 'Section', keys: 'backend tech stack spring kafka docker database networking osi section jump', run: function () { jumpTo('s2'); } },
